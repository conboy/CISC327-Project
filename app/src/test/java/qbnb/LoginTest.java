...
public class LoginTest {
    ...
    /**
     * Test R1-3: The email has to follow addr-spec defined in RFC 5322.
     * Try to login with an invalid email address.
     */
    @Test 
    ...
    /**
     * R1-5: User name has to be non-empty, alphanumeric-only, and space allowed only if it is not as the prefix or suffix.
     * Try to login with an invalid user name.
     */
    @Test 
     ...
     * Try to login with a user name shorter than 2 characters
     */
    @Test 
